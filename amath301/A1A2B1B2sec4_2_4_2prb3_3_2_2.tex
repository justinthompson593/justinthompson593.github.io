...
There are many ways to complete the function \texttt{evaluateF}. The most straightforward way I can think about is to use a \texttt{for} loop. We can use this method because MATLAB gives us a way to access the number of elements in 
